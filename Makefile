TESTS=bad bencode keys dht-address raw-signing parameter-signing webapi-basic webapi-ping webapi-signed-authentication webapi-long-poll webapi-dht webapi-seed webapi-retrieve
